...
from ImbutoTech.models import ImbutoTechSession, Fine
...
class Feedback(models.Model):
    ...
    session = models.ForeignKey(ImbutoTechSession, null=True, blank=True, on_delete=models.SET_NULL, related_name='feedbacks')
