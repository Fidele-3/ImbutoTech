...
class AdminActionLog(models.Model):
    ...
    action_type = models.CharField(
        ...
        choices=[
            ...
            ("ImbutoTech_created", "ImbutoTech Activity Created"),
            ("ImbutoTech_edited", "ImbutoTech Activity Edited"),
            ("ImbutoTech_deleted", "ImbutoTech Activity Deleted"),
            ("assignment_made", "Officer Assigned to ImbutoTech"),
            ("other", "Other"),
        ],
        default="other",
